        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <form method="GET" action="{{ route('memorandum-keluar.index') }}" class="flex items-center space-x-2">
                    ...
                    <a href="{{ route('memorandum-keluar.create') }}" 
                ...
                <div class="overflow-x-auto">
                    <table class="w-full border border-gray-300 text-sm">
                        ...
                        <tbody>
                            @forelse($memorandumKeluar as $index => $item)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-4 py-2 border text-center">
                                        {{ $loop->iteration + ($memorandumKeluar->currentPage() - 1) * $memorandumKeluar->perPage() }}
                                    </td>
