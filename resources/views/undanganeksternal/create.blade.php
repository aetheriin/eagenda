        ...
        <div class="max-w-4xl mx-auto px-6">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <h2 class="text-l font-semibold text-gray-800 mb-6">
                    Tambah Undangan Eksternal Keluar
                </h2>
                ...
                <!-- ✅ Form -->
                <form action="{{ route('undangan-eksternal.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <select name="keamanan_surat_id" id="keamanan_surat_id"
                            ...
                            @foreach($keamananSurat as $keamanan)
                                <option value="{{ $keamanan->id }}" {{ old('keamanan_surat_id') == $keamanan->id ? 'selected' : '' }}>
                                    {{ $keamanan->nama }}
                                </option>
                            @endforeach
                        </select>
