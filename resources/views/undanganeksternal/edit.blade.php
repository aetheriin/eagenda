                ...
                <form action="{{ route('undangan-eksternal.update', $undanganEksternal->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nomor_naskah" class="w-full border rounded px-3 py-2 bg-gray-100" 
                               value="{{ old('nomor_naskah', $undanganEksternal->nomor_naskah) }}" readonly>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="keamanan_surat" class="w-full border rounded px-3 py-2"
                               value="{{ old('keamanan_surat', $undanganEksternal->keamanan_surat) }}">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="perihal" class="w-full border rounded px-3 py-2"
                               value="{{ old('perihal', $undanganEksternal->perihal) }}">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="tujuan_penerima" class="w-full border rounded px-3 py-2"
                               value="{{ old('tujuan_penerima', $undanganEksternal->tujuan_penerima) }}">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="tanggal" class="w-full border rounded px-3 py-2"
                               value="{{ old('tanggal', $undanganEksternal->tanggal) }}">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-sm text-gray-500 mt-1">File saat ini:
                            <a href="{{ asset('storage/' . $undanganEksternal->file) }}" target="_blank" class="text-blue-600">Lihat File</a>
                        </p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="keterangan" rows="3" class="w-full border rounded px-3 py-2">{{ old('keterangan', $undanganEksternal->keterangan) }}</textarea>
                    </div>
