                ...
                <form action="{{ route('surat-dinas.update', $suratDinas->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nomor_naskah" class="w-full border rounded px-3 py-2 bg-gray-100" 
                               value="{{ old('nomor_naskah', $suratDinas->nomor_naskah) }}" readonly>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="keamanan_surat" class="w-full border rounded px-3 py-2"
                               value="{{ old('keamanan_surat', $suratDinas->keamanan_surat) }}">
                    </div>
                        ...
                        <select name="bagian_fungsi_id" class="w-full border rounded px-3 py-2">
                            ...
                            @foreach($bagianFungsi as $bagian)
                                <option value="{{ $bagian->id }}" 
                                    {{ old('bagian_fungsi_id', $suratDinas->bagian_fungsi_id) == $bagian->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="perihal" class="w-full border rounded px-3 py-2"
                               value="{{ old('perihal', $suratDinas->perihal) }}">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="tujuan_penerima" class="w-full border rounded px-3 py-2"
                               value="{{ old('tujuan_penerima', $suratDinas->tujuan_penerima) }}">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="tanggal" class="w-full border rounded px-3 py-2"
                               value="{{ old('tanggal', $suratDinas->tanggal) }}">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-sm text-gray-500 mt-1">File saat ini:
                            <a href="{{ asset('storage/' . $suratDinas->file) }}" target="_blank" class="text-blue-600">Lihat File</a>
                        </p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="keterangan" rows="3" class="w-full border rounded px-3 py-2">{{ old('keterangan', $suratDinas->keterangan) }}</textarea>
                    </div>
