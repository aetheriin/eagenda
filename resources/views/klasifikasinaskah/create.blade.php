    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-6">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <!-- ✅ Form -->
                <form action="{{ route('klasifikasi-naskah.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <!-- Kode -->
                    <div class="mb-4">
                        <label class="block text-gray-700 font-semibold mb-1">Kode <span class="text-red-500">*</span></label>
                    ...
                    <!-- Nama -->
                    <div class="mb-4">
                        <label class="block text-gray-700 font-semibold mb-1">Nama Klasifikasi <span class="text-red-500">*</span></label>
