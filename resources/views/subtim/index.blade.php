    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <h3 class="text-lg font-bold text-gray-800">Daftar Tim/Subtim Kerja</h3>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <form method="GET" action="{{ route('sub-tim.index') }}" class="flex items-center space-x-2">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full border border-gray-300 text-sm">
                        ...
                        <tbody>
                            @forelse($subTim as $index => $item)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-4 py-2 border text-center">
                                        {{ $loop->iteration + ($subTim->currentPage() - 1) * $subTim->perPage() }}
                                    </td>
                                    <td class="px-4 py-2 border">{{ $item->kode_subtim }}</td>
                                    <td class="px-4 py-2 border">{{ $item->nama_subtim }}</td>
                                </tr>
                            @empty
                                <tr>
