...
class SuratTugasController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('surattugas.create', compact('nomorUrut', 'bagianFungsi', 'keamananSurat', 'klasifikasiNaskah'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $path = $request->hasFile('file')
                ? $request->file('file')->store('surat_tugas', 'public')
                : null;
    ...
    public function edit($id)
    {
        ...
        return view('surattugas.edit', compact('suratTugas', 'bagianFungsi', 'keamananSurat', 'klasifikasiNaskah'));
    }
    ...
    public function update(Request $request, SuratTugas $suratTugas)
    {
        ...
        try {
            ...
            if ($request->hasFile('file')) {
                ...
                $data['file'] = $request->file('file')->store('surat_tugas', 'public');
            }
