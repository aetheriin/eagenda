...
class UndanganEksternalController extends Controller
{
    ...
    {
        $query = UndanganEksternal::with(['keamananSurat']);
    ...
    public function create()
    {
        ...
        return view('undanganeksternal.create', compact('nomorUrut', 'bagianFungsi', 'keamananSurat'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('undanganeksternal.edit', compact('undanganEksternal', 'bagianFungsi', 'keamananSurat'));
    }
